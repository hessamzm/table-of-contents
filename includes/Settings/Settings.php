...
final class Settings
{
    ...
    public function sanitize(array $settings): array
    {
        ...
        $productPosition = isset($settings['product_toc_position']) ? sanitize_key($settings['product_toc_position']) : 'inside_description';
        if ($productPosition === 'before_tabs') {
            $productPosition = 'inside_description';
        }

        $clean['product_toc_position'] = in_array($productPosition, ['before_summary', 'inside_description', 'after_tabs'], true)
            ? $productPosition
            : 'inside_description';
